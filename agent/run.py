...
class WebSocketManager:
    ...
    async def start_streaming(self, task, link, report_type, agent, agent_role_prompt, websocket):
        report, path = await run_agent(task, link, report_type, agent, agent_role_prompt, websocket)
        return report, path


async def run_agent(task, link, report_type, agent, agent_role_prompt, websocket):
    ...
    assistant = ResearchAgent(task, link, agent, agent_role_prompt, websocket)
